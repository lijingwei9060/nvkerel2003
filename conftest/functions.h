...
#define NV_JIFFIES_TO_TIMESPEC_PRESENT
...
#undef NV_OF_PROPERTY_COUNT_ELEMS_OF_SIZE_PRESENT
#undef NV_OF_PROPERTY_READ_VARIABLE_U8_ARRAY_PRESENT
#undef NV_I2C_NEW_CLIENT_DEVICE_PRESENT
...
#undef NV_DMA_BUF_ATTACHMENT_HAS_PEER2PEER
#define NV_DMA_SET_MASK_AND_COHERENT_PRESENT
#undef NV_DEVM_CLK_BULK_GET_ALL_PRESENT
